...
|---|---|---|---|---|---|---|
| WF-003 | Codex 主开发管线、旧 Task 1 隔离归档和新空壳部署 | Codex | `ab8675d` | `feature/codex-primary-reset` | REVIEW | 归档隔离、`doctor.ps1`、`verify.ps1` 和学习报告通过；H5 可视检查受 Browser 插件阻塞 |
| T1-000 | 新版 Task 1 跨端最小可运行空壳 | Codex | `ab8675d` | `feature/codex-primary-reset` | REVIEW | common/JS/H5 bundle/JVM/APK 通过；HTTP 200；可视渲染未验证 |
