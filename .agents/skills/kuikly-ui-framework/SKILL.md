...
---
> Kuikly workspace policy: read the current repository AGENTS.md and docs first. Do not clone or update external references automatically; such updates require an explicit task.
